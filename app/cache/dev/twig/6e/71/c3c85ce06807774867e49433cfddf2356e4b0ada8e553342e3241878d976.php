...
class __TwigTemplate_6e71c3c85ce06807774867e49433cfddf2356e4b0ada8e553342e3241878d976 extends Twig_Template
{
    ...
    <style>
        #cartButton {
            background: url(";
        // line 12
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/dvdworld/images/add-to-cart.png"), "html", null, true);
        echo ");
            border: 0;
            margin-left: 110%;
            display: block;
    ...
    ";
        ...
        <a href=\"";
            ...
            echo "\" height=\"50\" width=\"50\">Watch online!
        </a>
    ";
        } else {
            // line 120
    ...
    ";
        ...
        // line 122
        echo "    <div id=\"dialog\"> Item was added to your cart</div>
